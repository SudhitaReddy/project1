...
// import index'.../index.css'; // Import CSS if you create a separate file
        ...
        <div className="container mt-5">
            <div className="row text-center">
                ...
                <div className="col-4 p-3 mt-5">
                    ...
                    <p className="text-small text-muted">Optional Trading platform</p>
                </div>
                <div className="col-4 p-3 mt-5">
                ...
                <div className="col-4 p-3 mt-5">
                    ...
                    <p className="text-small text-muted">Bond trade platform</p>
                </div>
                <div className="col-4 p-3 mt-5">
